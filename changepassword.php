...
// get Token for session -> Validate the password inputs -> 
// if validation passed check hash or old password 
// if hash of old password the same hash new passowrd and store in database
if(Input::exists()) {
